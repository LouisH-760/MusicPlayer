...
public class FolderScanner implements Scanner {
	...
	/**
	 * return the last folder name (without /) of the path to use as album name. If
	 * you organize your library with picard, it should be an exact match except for
	 * any replaced characters
	 */
